...
class H5Data():
    def __init__(self, subject: str, run_id: str, cfg) -> None:
        ...
        print(len(electrode_labels_file))
        # assert len(electrode_labels_file)==1
        # electrode_labels_file = ["T1b2"]
        # electrode_labels_file = electrode_labels_file[0]
        self.electrode_labels_file = electrode_labels_file
        self.timestamp_data = os.path.join(dataset_dir, f'all_subject_data/{subject}_{trial}.json')
    ...
    def get_brain_region_localization(self) -> List[str]:
        ...
        '''
        print("DEBUG ELECTRODE LABELS FILES: ", self.electrode_labels_file)
        with open(self.electrode_labels_file[0], "r") as f:
