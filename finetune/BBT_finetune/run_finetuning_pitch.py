"""Pitch fine-tuning sweep for FGNO on Brain Treebank electrodes."""
...
def main():
    run_bbt_finetune_sweep(
        config_name="custom_pitch_finetune.yaml",
        task_name="pitch",
        results_default="outputs/pitch_finetuning_result.csv",
        layer_sets=[[5]],
        epochs=100,
        lr=1e-4,
