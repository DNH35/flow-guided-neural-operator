"""Sentence-onset fine-tuning sweep for FGNO on Brain Treebank electrodes."""
...
def main():
    run_bbt_finetune_sweep(
        config_name="custom_sentence_finetune.yaml",
        task_name="sentence",
        results_default="outputs/sentence_finetuning_result.csv",
